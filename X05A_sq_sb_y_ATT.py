...
from models import ATT_dataset, ATT_loader, Encoder, Weight_linear
...
#########################################################################################################
#########################################################################################################
train_loader, valid_loader, test_loader = ATT_loader(ATT_dataset, X_tr_seqs, X_tr_subs, y_tr, batch_size, X_va_seqs, X_va_subs, y_va, X_ts_seqs, X_ts_subs, y_ts)
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$#
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$#
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$#
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$#
...
for epoch in range(epoch_num): 
    ...
    for one_seqsubs_ppt_group in train_loader:
        ...
        count_x+=1
        #--------------------------------------------------#
        seq_rep, mask_rep, subs_rep, target = one_seqsubs_ppt_group["embedding"], one_seqsubs_ppt_group["mask"], one_seqsubs_ppt_group["substrate"], one_seqsubs_ppt_group["target"]
        seq_rep, mask_rep, subs_rep, target = seq_rep.double().cuda(), mask_rep.double().cuda(), subs_rep.double().cuda(), target.double().cuda()
        output, _ = model(seq_rep, mask_rep, subs_rep)
    ...
    for one_seqsubs_ppt_group in valid_loader:
        seq_rep, mask_rep, subs_rep, target = one_seqsubs_ppt_group["embedding"], one_seqsubs_ppt_group["mask"], one_seqsubs_ppt_group["substrate"], one_seqsubs_ppt_group["target"]
        seq_rep, mask_rep, subs_rep = seq_rep.double().cuda(), mask_rep.double().cuda(), subs_rep.double().cuda()
        output, _ = model(seq_rep, mask_rep, subs_rep)
